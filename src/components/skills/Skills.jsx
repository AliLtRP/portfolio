  ...
  return (
    <div className='w-[1000px] h-full flex flex-col items-center text-white relative'>
      <p className='text-2xl'>
        I&apos;m currently looking to join a <span className='text-[#A362FF]'>cross-functional</span> team that 
        <span className='block text-[17px] text-center'>values improving people&apos;s lives through accessible design</span>
      </p>
